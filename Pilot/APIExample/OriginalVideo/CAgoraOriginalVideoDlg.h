...
public:
	...
	*/
	...
	bool sendNDIFrameExternalYUVFrame(VideoFrame& videoFrame);
	bool sendNDIFrameNDIExample(VideoFrame& videoFrame);
	bool sendNDIFrameAgoraOutput(VideoFrame& videoFrame);
...
public:
	...
	*/
	...
	//bool sendNDIFrame(VideoFrame& videoFrame);
};
